...
# monish
    ...
    def get_internal_gain_forecast(self, skew_scalar, time):
        ...
        :return: list of 48 values of total zipl loads and total internal gain due to zip loads
        """
        zip_load = [0.0] * 48
        int_gain = [0.0] * 48
...
if __name__ == "__main__":
    ...
    for i in range(0,150):
        ...
        forecast_zpload,forecast_internalgain = obj.get_internal_gain_forecast(skew_scalar, current_time + timedelta(0, 60))
    elapsed = time.time() - t
