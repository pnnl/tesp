...
for i in range(len(cases)):
    pre_file_out ='C:/Users/tbai440/tesp-private/examples/dsot_v3/wh_hvac_error{}/'.format(cases[i]) #
    pos_file ='.json'
    ...
    to_kW = 1
    plt.plot((AVG_power.resample('60min').mean()/ to_kW).index,(AVG_power.resample('60min').mean()/ to_kW).values, marker='x', label = labels[i])
...
houses = {"R5_12_47_2_tn_2_hse_1":0.9776,"R5_12_47_2_load_10_bldg_82_zone_all":0.71,"R5_12_47_2_tn_133_hse_1":0.71,"R5_12_47_2_tn_1_hse_1":0.1295,"R5_12_47_2_tn_3_hse_4":0.3273,"R5_12_47_2_tn_3_hse_5":0.0295,"R5_12_47_2_tn_4_hse_3":0.1225}
#houses = {"R5_12_47_2_load_10_bldg_82_zone_all":0.71}

plot_data = {}
for ii in range(len(cases)):
    plot_data_case = {}
    pre_file_out = 'C:/Users/tbai440/tesp-private/examples/dsot_v3/wh_hvac_error{}/'.format(cases[ii])  #
    pos_file = '.json'
    pre_file = pre_file_out + 'Substation_2/'
    V_file = 'Substation_2_metrics_house'
    meta_S, start_time, data_s, data_individual, data_key = get_metrics_full_multiple_KEY(V_file, pre_file, pos_file)
