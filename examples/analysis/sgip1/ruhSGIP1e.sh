...
(exec python3 -c "import tesp_support.api.substation as tesp;tesp.substation_loop('SGIP1e_agent_dict.json', 'SGIP1e', helicsConfig='SGIP1b_substation.json')" &> substation1e.log &)
