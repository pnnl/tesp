...
# @Last modified time: 2021-10-07T10:49:22-07:00
...
def read_gld_metrics (path, nameroot, dictname='' ):
  ...
  if len (dictname) > 0:
      # dictname = inverter_dict_path
      lp = open (dictname).read()
      # lp = open(inverter_dict_path)  # inverter_{nameroot}_metrics.json
  else:
