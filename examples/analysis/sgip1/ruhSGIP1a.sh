...
(exec python3 -c "import tesp_support.api.substation as tesp;tesp.substation_loop('SGIP1b_agent_dict.json', 'SGIP1a',flag='NoMarket', helicsConfig='SGIP1b_substation.json')" &> substation1a.log &)
...
(export WEATHER_CONFIG=SGIP1b_weather.json && exec python3 -c "import tesp_support.weather.weather_agent as tesp;tesp.startWeatherAgent('weather.dat')" &> weather1a.log &)
