...
#### EVs
    if EV_agent:
        #base run results
        gld_pre_file_base =  pre_file_out_base + f'Substation_{dso_num}/'
        V_file_base = f'Substation_{dso_num}_metrics_substation'
        ...
        V_file = f'Substation_{dso_num}_metrics_evchargerdet'
