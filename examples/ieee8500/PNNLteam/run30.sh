...
(export FNCS_CONFIG_FILE=inv30_precool.yaml && export FNCS_FATAL=YES && export FNCS_LOG_STDOUT=yes && exec python3 -c "import tesp_support.api as tesp;tesp.precool_loop(48,'inv30','inv30')" &> precool30.log &)
