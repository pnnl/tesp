javac -classpath ".:../../src/java" loadshed.java
...
(export FNCS_CONFIG_FILE=loadshed.yaml && export FNCS_FATAL=YES && export FNCS_LOG_STDOUT=yes && exec java -classpath ".:../../src/java" -Djava.library.path="../../src/java" loadshed 21600 &> java.log &)
