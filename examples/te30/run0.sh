...
(export FNCS_CONFIG_FILE=TE_Challenge_auction.yaml && export FNCS_FATAL=YES && exec python3 -c "import tesp_support.api as tesp;tesp.auction_loop('TE_Challenge_agent_dict.json','TE_Challenge0',flag='NoMarket')" &> auction0.log &)
