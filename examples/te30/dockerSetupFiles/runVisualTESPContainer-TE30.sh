...
docker cp ${HOME}/work/downloads/tespTE30.py ${TESP_CONT}:/tesp/runScripts
docker cp ${HOME}/work/downloads/tespTE30.yaml ${TESP_CONT}:/tesp/runScripts
docker cp ${HOME}/work/CoSimulation/TESP-pypower/fncs.py.DockerVersion ${TESP_CONT}:/tesp/runScripts/fncs.py
docker cp ${HOME}/work/downloads/runVisualTE30ChallengeDocker.sh ${TESP_CONT}:/tesp/runScripts
...
docker cp ${HOME}/work/CoSimulation/TESP-GridLABD1048install/bin/modelFiles/ ${TESP_CONT}:/tesp/GridLABD1048Install/bin/
docker cp ${HOME}/work/CoSimulation/TESP-GridLABD1048install/bin/inputFilesTE30/ ${TESP_CONT}:/tesp/GridLABD1048Install/bin/
docker cp ${HOME}/work/CoSimulation/TESP-GridLABD1048install/bin/outputFiles/ ${TESP_CONT}:/tesp/GridLABD1048Install/bin/
...
docker cp ${HOME}/work/CoSimulation/ENERGYPLUSinstall/eplus.yaml ${TESP_CONT}:/tesp/EnergyPlusInstall/
docker cp ${HOME}/work/CoSimulation/ENERGYPLUSinstall/USA_AZ_Tucson.Intl.AP.722740_TMY3.epw ${TESP_CONT}:/tesp/EnergyPlusInstall/
docker cp ${HOME}/work/CoSimulation/ENERGYPLUSinstall/SchoolDualController.idf ${TESP_CONT}:/tesp/EnergyPlusInstall/
...
docker cp ${HOME}/work/CoSimulation/ENERGYPLUS_JSONinstall/eplus_json.yaml ${TESP_CONT}:/tesp/EPlusJSONInstall/
...
docker cp ${HOME}/work/CoSimulation/TESP-pypower/NonGLDLoad.txt ${TESP_CONT}:/tesp/PyPowerInstall/
docker cp ${HOME}/work/CoSimulation/TESP-pypower/ppcasefile.py ${TESP_CONT}:/tesp/PyPowerInstall/
docker cp ${HOME}/work/CoSimulation/TESP-pypower/pypowerConfig_TE30dispload.yaml ${TESP_CONT}:/tesp/PyPowerInstall/
...
docker cp ${HOME}/work/CoSimulation/Agents/inputFilesPP ${TESP_CONT}:/tesp/AgentsInstall/inputFilesPP
docker cp ${HOME}/work/CoSimulation/Agents/launch_TE30_Challenge_PYPOWER_agents.sh.DockerVersion ${TESP_CONT}:/tesp/AgentsInstall/launch_TE30_Challenge_PYPOWER_agents.sh
