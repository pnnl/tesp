...
(export FNCS_BROKER="tcp://*:5570" && exec fncs_broker 35 &> broker.log &)
...
(export FNCS_CONFIG_FILE=pypower30.yaml && export FNCS_FATAL=NO && export FNCS_LOG_STDOUT=yes && exec python fncsPYPOWER.py TE_Challenge "2013-07-01 00:00:00" 172800 300 5 &> pypower.log &)
