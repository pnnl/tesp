...
(export FNCS_CONFIG_FILE=SGIP1e_auction.yaml && export FNCS_FATAL=YES && exec python -c "import tesp_support.api as tesp;tesp.auction_loop('SGIP1e_agent_dict.json','SGIP1ex','NoMarket')" &> auction1ex.log &)
