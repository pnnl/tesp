...
(export FNCS_CONFIG_FILE=SGIP1b_auction.yaml && export FNCS_FATAL=YES && exec python -c "import tesp_support.api as tesp;tesp.auction_loop('SGIP1b_agent_dict.json','SGIP1a','NoMarket')" &> auction1a.log &)
