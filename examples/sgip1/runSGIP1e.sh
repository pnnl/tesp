...
(export FNCS_FATAL=NO && export FNCS_LOG_STDOUT=yes && exec ./run_fncsMATPOWER.sh SGIP1e.m real_power_demand_case9_T.txt 171800 "2013-07-01 00:00:00" SGIP1e &> matpower.log &)
