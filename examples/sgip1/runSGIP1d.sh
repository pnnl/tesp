...
(export FNCS_CONFIG_FILE=SGIP1d_substation.yaml && export FNCS_FATAL=YES && exec python -c "import tesp_support.api as tesp;tesp.substation_loop('SGIP1d_agent_dict.json','SGIP1d')" &> substation1d.log &)
