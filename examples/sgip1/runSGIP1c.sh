...
(export FNCS_CONFIG_FILE=SGIP1c_substation.yaml && export FNCS_FATAL=YES && exec python -c "import tesp_support.api as tesp;tesp.substation_loop('SGIP1c_agent_dict.json','SGIP1c')" &> substation1c.log &)
