...
python3 -c "import tesp_support.api.make_ems as tesp;tesp.merge_idf('SchoolBase.idf','./forSchoolBase/emsSchoolBaseH.idf', '2013-08-01 00:00:00', '2013-08-03 00:00:00', 'Merged.idf', '12')"
