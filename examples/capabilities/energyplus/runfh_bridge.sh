...
#python3 -c "import tesp_support.api.make_ems as tesp;tesp.merge_idf('$EPLUS_PATH/FullServiceRestaurant.idf','emsFullServiceRestaurant.idf', '2013-08-01 00:00:00', '2013-08-03 00:00:00', 'Merged.idf', '12')"
python3 -c "import tesp_support.api.make_ems as tesp;tesp.merge_idf('SchoolBase.idf','./forSchoolBase/emsSchoolBase.idf', '2013-08-01 00:00:00', '2013-08-03 00:00:00', 'Merged.idf', '12')"
...
(exec helics_player prices.txt -n player --local --time_units=ns --stop 172800s &> helics_player.log &)
(exec helics_recorder --config-file helicsRecorder.txt --timedelta 1s --period 300s --stop 172800s &> helics_recorder.log &)
