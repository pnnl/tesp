...
lp_m = open (os.path.join(os.path.abspath(outputFolder), "billing_meter_" + sys.argv[1] + "_metrics.json")).read()
...
lp_s = open (os.path.join(os.path.abspath(outputFolder), "substation_" + sys.argv[1] + "_metrics.json")).read()
...
emetrics = ep.read_eplus_metrics(os.getcwd(), 'agent')
