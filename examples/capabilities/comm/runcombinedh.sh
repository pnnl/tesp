...
(exec python3 -c "import tesp_support.api.substation as tesp;tesp.substation_loop('CombinedCase_agent_dict.json','CombinedCaseH',helicsConfig='CombinedCase_substation.json')"  &> sub_7.log &)
...
(export WEATHER_CONFIG=Feeder1_weather.json && exec python3 -c "import tesp_support.weather.weather_agent as tesp;tesp.startWeatherAgent('weather.dat')"  &> weather.log &)
