...
(exec gridlabd -D USE_HELICS -D METRICS_FILE=TE_ChallengeH_metrics.h5 TE_Challenge.glm &> gridlabd.log &)
(exec python3 -c "import tesp_support.api.substation as tesp;tesp.substation_loop('TE_Challenge_agent_dict.json','TE_ChallengeH',helicsConfig='TE_Challenge_substation.json')" &> substation.log &)
