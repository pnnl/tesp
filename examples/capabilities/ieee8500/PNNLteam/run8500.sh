...
(export FNCS_CONFIG_FILE=inv8500_precool.yaml && export FNCS_FATAL=YES && export FNCS_LOG_STDOUT=yes && exec python3 -c "import tesp_support.original.precool as tesp;tesp.precool_loop(24,'inv8500','inv8500',response='PriceVoltage')" &> precool8500.log &)
