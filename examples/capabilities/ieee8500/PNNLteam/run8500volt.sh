...
(export FNCS_CONFIG_FILE=inv8500_precool.yaml && export FNCS_FATAL=YES && export FNCS_LOG_STDOUT=yes && exec python3 -c "import tesp_support.precool as tesp;tesp.precool_loop(24,'inv8500_volt','inv8500',response='Voltage')" &> precool8500_volt.log &)
