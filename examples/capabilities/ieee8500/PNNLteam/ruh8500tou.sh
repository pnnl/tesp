...
(exec python3 -c "import tesp_support.api as tesp;tesp.precool_loop(24, 'inv8500_tou', 'inv8500', response='Price', helicsConfig='inv8500_precool.json')" &> precool8500_tou.log &)
