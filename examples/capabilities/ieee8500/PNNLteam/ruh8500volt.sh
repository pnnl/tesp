...
(exec python3 -c "import tesp_support.precool as tesp;tesp.precool_loop(24, 'inv8500_volt', 'inv8500', response='Voltage', helicsConfig='inv8500_precool.json')" &> precool8500_volt.log &)
