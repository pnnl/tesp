...
(export WEATHER_CONFIG=HelicsWeatherConfig.json && exec python3 -c "import tesp_support.weather_agent as tesp;tesp.startWeatherAgent('weather.dat')" &> weather_helics.log &)
