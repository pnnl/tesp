...
def main(taxonomyRoot):
  ...
  casefiles = [choice for choice in taxchoice if choice[0] == taxonomyRoot]
  print('\nPicked: {0}\n'.format(casefiles))
  #[[taxonomyRoot, 12470.0, 7200.0, 4000.0, 20000.0]]

  fg.ProcessTaxonomyFeeder('{0}_processed'.format(casefiles[0][0]), casefiles[0][0], casefiles[0][1], casefiles[0][2], casefiles[0][3], casefiles[0][4])
...
if __name__ == '__main__':
  ...
  # taxRoot = ['R1-12.47-2', 'R4-12.47-2']
  for feeder in taxRoot:
    print('Processing taxonomy feeder {0}.....'.format(feeder))
    main(feeder)
    print('====================================================')
