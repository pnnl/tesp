...
(export FNCS_LOG_STDOUT=yes && export FNCS_CONFIG_FILE=eplus.yaml && exec energyplus -w $TESP_SUPPORT/energyplus/USA_IN_Indianapolis.Intl.AP.724380_TMY3.epw -d outSchoolBase -r $TESP_SUPPORT/energyplus/SchoolDualController.idf &> eplus.log &)
