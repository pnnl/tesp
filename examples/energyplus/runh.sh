...
declare -r EPW=$TESP_SUPPORT/energyplus/USA_IN_Indianapolis.Intl.AP.724380_TMY3.epw
...
(export HELICS_CONFIG_FILE=eplusH.json && exec energyplus -w $EPW -d output -r Merged.idf &> eplusH.log &)
