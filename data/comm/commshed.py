...
def helics_loop(tmax, market_period, thresh_kW, max_offset_kW):
    ...
    print('Federate {:s} has {:d} pub and {:d} sub, {:d} period, {:d} market_period and {:d} next_market'.
          format(fedName, pubCount, subCount, period, market_period, next_market), flush=True)
