...
# file: runTE30-noMarket.sh

clear
scenarioFolder="te30"
scenarioName="TE_Challenge"
scenarioType="NoMarket"
...
cd ${SCEN_ROOT} && \
python -c "import tesp_support.api as tesp;tesp.pypower_loop('te30_pp.json','${scenarioName}_${scenarioType}')" &> $ppOutFile &
