...
class ChoosablePlot(tk.Frame):
  def __init__(self, master, color='red', xLabel='', topicDict={}, **kwargs):
    ...
    self.combobox = ttk.Combobox(self.topicSelectionRow, values=self.listOfTopics, textvariable=self.title, background="#ffffff", width=50, state="readonly")
    ...
    self.voltageBaseTextbox = tk.Entry(self.topicSelectionRow, textvariable=self.voltageBase, relief=tk.RIDGE, background="#ffffff", width=15,highlightthickness=0, highlightbackground='White')
