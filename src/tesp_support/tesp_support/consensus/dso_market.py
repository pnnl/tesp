...
class DSOMarket:
    ...
    def set_Pwclear_RT(self, hour_of_day, day_of_week):
        ...
        self.Pwclear_RT, self.trial_cleared_quantity_RT, self.trial_clear_type_RT = (
            self.trial_wholesale_clearing(self.curve_ws_node[day_of_week][hour_of_day], self.curve_DSO_RT))
    ...
    def substation_supply_curve_RT(self, retail_obj):
        ...
        supply_curve_RT = Curve(self.retail_rate(self.price_cap),
                                self.num_samples)  # price_cap of the supply_curve has to be the retail price_cap
        ...
        if self.transformer_degradation:
            ...
            # the DSO's Q_max has been increased after observing buyer bids to be higher than the substation Q max
            ...
            price_max_congestion = congestion_quantity * retail_obj.FeederCongPrice  # placeholder for congestion surcharge
