...
class DSO_LMPs_vs_Q:
    ...
    def __init__(self,config_path='LMP_DATA',file_name='/Annual_DA_LMP_Load_data.csv'):
        ...
        self.df_dsos_lml_q, self.lmps_names, self.q_lmps_names = self.organize_remuve_outliers(data_da)#Organize and remove outliers
        #Curve parameters 
...
if __name__ == "__main__":
    ...
    ax.grid()
    ax.set(xlabel='quantity (KWh)', ylabel='price ($)',
            title='weekdays')
    fig.tight_layout()
