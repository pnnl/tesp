...
#    r = input("Ready")
    ...
    for key in hvac_keys:
        ...
        if '#temperature' not in topic_map:
        ...
        if '#temperature#forecast' not in topic_map:
        ...
        if '#solar_direct' not in topic_map:
        ...
        if '#solar_diffuse' not in topic_map:
