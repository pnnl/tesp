...
"""
    ...
    data = tesp_support.dsot.DSOT_plots.load_json(path, 'sankey_cost_structure.json')
    ...
    if update_data:
        ...
        for dso in dso_range:
            revenue = tesp_support.dsot.DSOT_plots.load_json(results_path,
                                                        'DSO' + str(dso) + '_Revenues_and_Energy_Sales.json')
            expenses = tesp_support.dsot.DSOT_plots.load_json(results_path, 'DSO' + str(dso) + '_Expenses.json')
...
"""
    ...
    data = tesp_support.dsot.DSOT_plots.load_json(path, 'sankey_delta_cost_structure.json')
    ...
    if update_data:
        ...
        metadata = tesp_support.dsot.DSOT_plots.load_json(path, metadata_file)
        ...
        for dso in dso_range:
            ...
            revenue_comp = tesp_support.dsot.DSOT_plots.load_json(comp_path,
                                                             'DSO' + str(dso) + '_Revenues_and_Energy_Sales.json')
            expenses_comp = tesp_support.dsot.DSOT_plots.load_json(comp_path, 'DSO' + str(dso) + '_Expenses.json')
            capital_costs_comp = tesp_support.dsot.DSOT_plots.load_json(comp_path, 'DSO' + str(dso) + '_Capital_Costs.json')
...
"""
    ...
    path = expandvars("$TESPDIR/examples/analysis/dsot/data")
    data = tesp_support.dsot.DSOT_plots.load_json(path, 'sankey_energy_structure.json')
