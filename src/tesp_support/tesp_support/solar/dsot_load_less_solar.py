...
profile the actual five minute solar data is used. Users can select whether
...
def parse_DSO_metadata_Excel(dso_metadata_path_Excel,
                                  worksheet_name):
...
def create_load_less_solar(input_load_filename, output_load_filename,
                           solar_dir, load_dir, mode):
    """
    ...
    :param load_filename: Filename of input load data
    :param solar_dir: Directory of input solar data
    :param load_dir: Directory of input load data
    :return load_data: list of list of load data less solar
    """
