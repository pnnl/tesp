...
% file: TechnologyParameters_TSP.m


function [data,use_flags] = TechnologyParameters_TSP(use_flags,TechToTest)
%% Tech flags
...
if data.tech_flag == 0
    ...
    use_flags.use_solar_res = 1; %Adds solar and storage all at once 

    % These will include recorders/collectors/dumps
    use_flags.use_billing = 1;
    use_flags.use_emissions = 0;
    use_flags.use_capacitor_outtages = 0; % 1;
    use_flags.use_vvc = 0;
    use_flags.use_market = 0;
...
if (use_flags.use_solar ==1 || use_flags.use_solar_res ==1 || use_flags.use_solar_com ==1 )
    ...
    %Parameters for any associated energy storage
    data.efficiency = 0.86;   %percent
