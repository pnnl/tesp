# FNCS_CHECK_HEADERS(HEADER-FILE...,
...
AC_DEFUN([FNCS_CHECK_HEADERS],
[m4_map_args_w([$1], [_AH_CHECK_HEADER(], [)])]dnl
[AS_FOR([AC_header], [ac_header], [$1],
[AC_CHECK_HEADER(AC_header,
    [AC_DEFINE_UNQUOTED(AS_TR_CPP([HAVE_]AC_header), 1,
        [Define to 1 if you have the <]AC_header[> header file, 0 if you don't]) $2],
    [AC_DEFINE_UNQUOTED(AS_TR_CPP([HAVE_]AC_header), 0,
        [Define to 1 if you have the <]AC_header[> header file, 0 if you don't]) $3], [$4])dnl])
])# FNCS_CHECK_HEADERS
