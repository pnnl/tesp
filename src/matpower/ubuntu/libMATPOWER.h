...
// Date: Tue Oct 28 21:58:54 2014
// Arguments: "-B" "macro_default" "-W" "cpplib:libMATPOWER" "-T" "link:lib"
// "-d" "./" "-N" "-p" "/usr/local/matlab_2013a/toolbox/optim/" "-I"
// "../matpower4.1/" "-v" "mpoption.m" "runpf.m" "runopf.m"
// "Aggregator_Optimization.m" "ToggleGenRamp.m" "Curve
// Fitting/Curve_Fitting.m" "DemandCurve_Incentive.m" 
//
...
extern LIB_libMATPOWER_C_API 
bool MW_CALL_CONV mlxAggregator_Optimization(int nlhs, mxArray *plhs[], int nrhs, mxArray 
                                             *prhs[]);

extern LIB_libMATPOWER_C_API 
bool MW_CALL_CONV mlxToggleGenRamp(int nlhs, mxArray *plhs[], int nrhs, mxArray *prhs[]);

extern LIB_libMATPOWER_C_API 
bool MW_CALL_CONV mlxCurve_Fitting(int nlhs, mxArray *plhs[], int nrhs, mxArray *prhs[]);

extern LIB_libMATPOWER_C_API 
bool MW_CALL_CONV mlxDemandCurve_Incentive(int nlhs, mxArray *plhs[], int nrhs, mxArray 
                                           *prhs[]);
...
extern LIB_libMATPOWER_CPP_API void MW_CALL_CONV mpoption(int nargout, mwArray& options, mwArray& names, const mwArray& varargin);

extern LIB_libMATPOWER_CPP_API void MW_CALL_CONV mpoption(int nargout, mwArray& options, mwArray& names);
...
extern LIB_libMATPOWER_CPP_API void MW_CALL_CONV Aggregator_Optimization(int nargout, mwArray& R, const mwArray& n, const mwArray& p, const mwArray& aa, const mwArray& bb, const mwArray& cc, const mwArray& dd, const mwArray& Rto, const mwArray& Rsp);

extern LIB_libMATPOWER_CPP_API void MW_CALL_CONV ToggleGenRamp(int nargout, mwArray& mpc, const mwArray& mpc_in1, const mwArray& on_off);

extern LIB_libMATPOWER_CPP_API void MW_CALL_CONV Curve_Fitting(int nargout, mwArray& a, mwArray& b, mwArray& c, mwArray& d, const mwArray& Px, const mwArray& Qx);

extern LIB_libMATPOWER_CPP_API void MW_CALL_CONV DemandCurve_Incentive(int nargout, mwArray& x, mwArray& y, mwArray& Incentive, const mwArray& aa, const mwArray& bb, const mwArray& cc, const mwArray& dd, const mwArray& p, const mwArray& R);
