...
class MeterNetwork:
    ...
    that we care about for analysis purpose. This data
    ...
    def from_excel(self, excel_file, sheet, columns):
        ...
        logger.info('Reformatting the meter position info for potting')
    ...
    def plot_graph(self, nodes, node_args, edges, edge_args, plot_positions,
        ...
        Args:
            ...
            updates, the plot_positions will be the default positions
            after instantiation of the MeterSystem object.
