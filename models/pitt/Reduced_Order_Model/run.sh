...
(export FNCS_CONFIG_FILE=pypower.yaml && export FNCS_FATAL=YES && export FNCS_LOG_STDOUT=yes && exec python -c "import tesp_support.api.tso_PYPOWER_f as tesp;tesp.pypower_loop_f('TE_pp.json','TE')" &> pypower.log &)
