...
def process_data1(input_rnn, output_rnn_p, output_rnn_l):
    ...
    for i in range(output_dim):
        ...
        output_rnn_norm_p[:, :, :, i] = (output_rnn_p[:, :, :, i] - output_min_p[i]) / (
                    output_max_p[i] - output_min_p[i])
    ...
    for i in range(output_dim):
        ...
        output_rnn_norm_l[:, :, :, i] = (output_rnn_l[:, :, :, i] - output_min_l[i]) / (
                    output_max_l[i] - output_min_l[i])
