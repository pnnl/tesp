...
def process_inv(name_root, diction_name=''):
    ...
    *inverter_[name_root]_metrics.json* for the data;
    ...
    lp_h = open("house_" + name_root + "_metrics.json").read()
    lst_h = json.loads(lp_h)
    lp_m = open("billing_meter_" + name_root + "_metrics.json").read()
    lst_m = json.loads(lp_m)
    lp_i = open("inverter_" + name_root + "_metrics.json").read()
    lst_i = json.loads(lp_i)
    lp_c = open("capacitor_" + name_root + "_metrics.json").read()
    lst_c = json.loads(lp_c)
    lp_r = open("regulator_" + name_root + "_metrics.json").read()
    ...
    lp_p = open("precool_" + name_root + "_metrics.json").read()
