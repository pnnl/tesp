...
if __name__ == "__main__":
    ...
    model_param = {
        "rc_param": ["/mnt/shared/develop/w_energyplus/models/TestModels.mo",
                     "TestModels.MPC.R" + str(NUM_RC) + "C" + str(NUM_RC) + "HeatCool", {mo_libs}],
        "param_fil": "/mnt/shared/develop/w_energyplus/parameters/R" + str(NUM_RC) + "C" + str(
            NUM_RC) + "HeatCool/Parameters.csv",
        "con_fil": "/mnt/shared/develop/w_energyplus/parameters/R" + str(NUM_RC) + "C" + str(
            NUM_RC) + "HeatCool/ControlSignal.csv",
