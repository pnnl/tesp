...
ENV ENERGYPLUS_VERSION {{ep_vers}}
ENV ENERGYPLUS_TAG {{ep_tag}}
ENV ENERGYPLUS_SHA {{ep_sha}}

# This should be x.y.z, but EnergyPlus convention is x-y-z
ENV ENERGYPLUS_INSTALL_VERSION {{ep_versm}}

# Downloading from Github
# e.g. https://github.com/NREL/EnergyPlus/releases/download/{{ep_tag}}/EnergyPlus-{{ep_vers}}-{{ep_sha}}-Linux-x86_64.sh
...
RUN ["ln", "-s", "/usr/local/EnergyPlus-{{ep_versm}}/Energy+.idd", "/usr/local/Energy+.idd"]
