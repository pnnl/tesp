...
- Create a tesp environment, e.g., `win-tesp`. Using Conda, from the terminal: `conda create --name win-tesp python=3.10`
- Install pip. Using Conda, from the terminal: `conda install pip`
- Clone the tesp repository: https://github.com/pnnl/tesp. VS Code [Git Instructions](https://code.visualstudio.com/docs/sourcecontrol/intro-to-git#:~:text=To%20clone%20a%20repository%2C%20run,to%20clone%20to%20your%20machine) 
