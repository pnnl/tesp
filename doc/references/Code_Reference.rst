...
- **tesp_support**; runs PYPOWER without FNCS
  ...
  - **tesp_support**; Python code for agents, configuration and post-processing.
    ...
    - *auction.py*; supervises one double-auction and multiple HVAC agents for a feeder; communicates via HELICS with GridLAB-D and PYPOWER/AMES
    ...
    - *prep_auction.py*; configures the agent metadata (JSON) and GridLAB-D HELICS subscriptions/publications for the double-auction, double-ramp simulations
